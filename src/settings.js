    ...
    display() {
        ...
        if (!isPerOp) {
            new Setting(containerEl)
                ...
                .addText((t) => t.setPlaceholder("4096")
        ...
        new Setting(containerEl)
            ...
            .addText((t) => t.setValue(`${s.timeouts.ingest}/${s.timeouts.query}/${s.timeouts.lint}/${s.timeouts.init}`)
            .onChange(async (v) => {
        ...
        new Setting(containerEl)
            ...
            .addText((t) => t.setValue(String(s.historyLimit))
            .onChange(async (v) => {
            const n = Number(v);
            if (Number.isFinite(n) && n > 0) {
        ...
        new Setting(containerEl)
            ...
            .addText((t) => t.setPlaceholder("/tmp/llm-wiki-agent.jsonl")
        ...
        if (domains.length === 0) {
            ...
            for (let i = 0; i < domains.length; i++) {
                ...
                new Setting(containerEl)
                    .setName(d.name || d.id)
                    .setDesc(d.id)
                    .addButton((b) => b.setButtonText(T.settings.editDomain).onClick(() => {
                    ...
                    .addButton((b) => b.setButtonText(T.settings.deleteDomain).setWarning().onClick(() => {
        ...
        new Setting(containerEl)
            ...
            .addDropdown((d) => d.addOption("claude-agent", T.settings.claudeCodeAgent)
        ...
        if (s.backend === "claude-agent") {
            new Setting(containerEl)
                ...
                .addText((t) => t.setPlaceholder("/home/user/Documents/Project/iclaude/iclaude.sh")
            ...
            new Setting(containerEl)
                ...
                .addToggle((t) => t.setValue(s.claudeAgent.perOperation)
            ...
            if (s.claudeAgent.perOperation) {
                ...
                for (const { key, label } of ops) {
                    ...
                    new Setting(containerEl)
                        ...
                        .addText((t) => t.setValue(s.claudeAgent.operations[key].model)
                    ...
                    new Setting(containerEl)
                        ...
                        .addText((t) => t.setValue(String(s.claudeAgent.operations[key].maxTokens))
                        .onChange(async (v) => {
                        const n = Number(v);
                        if (Number.isFinite(n) && n > 0) {
            ...
            if (!s.nativeAgent.perOperation) {
                ...
                new Setting(containerEl)
                    ...
                    .addText((t) => t.setPlaceholder("(дефолт модели)")
                ...
                new Setting(containerEl)
                    ...
                    .addText((t) => t.setPlaceholder("0.2")
            ...
            new Setting(containerEl)
                .setName(T.settings.perOperation_name)
                .setDesc(T.settings.perOperation_desc)
                .addToggle((t) => t.setValue(s.nativeAgent.perOperation)
            ...
            if (s.nativeAgent.perOperation) {
                ...
                for (const { key, label } of ops) {
                    ...
                    new Setting(containerEl)
                        .setName(T.settings.opModel_name)
                        .setDesc(T.settings.opModel_desc)
                        .addText((t) => t.setValue(s.nativeAgent.operations[key].model)
                        .onChange(async (v) => { s.nativeAgent.operations[key].model = v.trim(); await this.plugin.saveSettings(); }));
                    new Setting(containerEl)
                        .setName(T.settings.opMaxTokens_name)
                        .setDesc(T.settings.opMaxTokens_desc)
                        .addText((t) => t.setValue(String(s.nativeAgent.operations[key].maxTokens))
                        .onChange(async (v) => {
                        const n = Number(v);
                        if (Number.isFinite(n) && n > 0) {
                    ...
                    new Setting(containerEl)
                        ...
                        .addText((t) => t.setValue(String(s.nativeAgent.operations[key].temperature))
                        .onChange(async (v) => {
                        const n = Number(v);
                        if (Number.isFinite(n) && n >= 0 && n <= 2) {
