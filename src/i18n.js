...
const en = {
    settings: {
        ...
        domainDeleted: (id) => `Domain «${id}» deleted`,
    ...
    ctrl: {
        ...
        noActiveFile: "No active file",
        domainAdded: (id) => `Domain «${id}» added`,
...
const ru = {
    settings: {
        ...
        confirmDeleteDomain: (id) => `Удалить домен «${id}»?`,
        domainDeleted: (id) => `Домен «${id}» удалён`,
    ...
    ctrl: {
        cancelling: "Отмена…",
        noActiveFile: "Нет активного файла",
        domainAdded: (id) => `Домен «${id}» добавлен`,
...
const es = {
    settings: {
        ...
        confirmDeleteDomain: (id) => `¿Eliminar dominio "${id}"?`,
        domainDeleted: (id) => `Dominio «${id}» eliminado`,
    ...
    ctrl: {
        ...
        noActiveFile: "No hay archivo activo",
        domainAdded: (id) => `Dominio «${id}» añadido`,
        domainAddFailed: (err) => `Error al añadir dominio: ${err}`,
    ...
    modal: {
        ...
        wikiFolder_desc: (root) => `Ruta relativa a la raíz del vault. Vacío = ${root}/<id>. Las rutas de fuentes se rellenan automáticamente en ingest.`,
        wikiFolder_placeholder: (root) => `${root}/<id>`,
